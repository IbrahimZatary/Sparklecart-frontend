  ...
  const handleCheckout = async () => {
    ...
    try {
      await apiClient.post("/cart/checkout", {
        ...
        shippingAddress: "Default Address fot ship",
      });
    ...
    cart.items.reduce(
      (sum, item) =>
        ...
        (item.subtotal ||
          ...
          item.quantity * (item.unitPrice || item.productPrice || 0)),
      0,
    );
              ...
              <div className="bg-white rounded-lg shadow overflow-hidden">
                ...
                <div className="divide-y divide-gray-200">
                  {cart.items.map((item) => {
                    ...
                    const unitPrice = item.unitPrice || item.productPrice;
                    const subtotalItem =
            ...
            <div className="lg:w-96">
              <div className="bg-white rounded-lg shadow p-6 sticky top-4">
                ...
                <div className="space-y-3 border-b pb-4">
                  ...
                  <div className="flex justify-between text-gray-600">
                    <span>Estimated Tax 10 percent</span>
